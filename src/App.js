...
firebase.initializeApp({
  apiKey: "AIzaSyAJgcF2Dctm5cJYO8tmwGBgva4xGR0ioxU",
  authDomain: "task-4790e.firebaseapp.com",
});
          ...
          <div className="user">
            <div className="top">
              <div className="imgbody">
                <img src={firebase.auth().currentUser.photoURL} alt="photo" />
              </div>
              <div className="detailbody">
                <h3>Username:- {firebase.auth().currentUser.displayName}</h3>
